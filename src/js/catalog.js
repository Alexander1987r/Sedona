import { getScreenWidth } from "./util.js";
import { getSwitchingActive } from "./util.js";

const videoPlayer=document.querySelector('.video__player');
//функция создания трейлера

const getTreils=()=>{
   //создадим iframe
   const trailersVideoIframe=document.createElement('iframe');
   trailersVideoIframe.classList.add('video__player-trailers');
   trailersVideoIframe.src="https://www.youtube.com/embed/ApZTxOPoa54?si=PiHJDg5lLzkq4qWX";
   videoPlayer.innerHTML='';
   videoPlayer.appendChild(trailersVideoIframe);

   trailersVideoIframe.srcdoc=`
   <style>
   *{
     padding: 0;
     margin: 0;
...
<iframe class="video__player-trailers" src="https://www.youtube.com/embed/ApZTxOPoa54?si=PiHJDg5lLzkq4qWX"  frameborder="0">
</iframe>
</div>
*/
